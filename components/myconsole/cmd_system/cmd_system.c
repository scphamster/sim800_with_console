...
deep_sleep(int argc, char **argv)
{
    ...
    if (deep_sleep_args.wakeup_gpio_num->count) {
        ...
        ESP_LOGI(TAG,
                 "Enabling wakeup on GPIO%d, wakeup on %s level",
                 io_num,
                 level ? "HIGH" : "LOW");
...
static int
light_sleep(int argc, char **argv)
{
    ...
    default: cause_str = "unknown"; printf("%d\n", cause);
    }
